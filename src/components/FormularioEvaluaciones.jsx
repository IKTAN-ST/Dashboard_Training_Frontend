      ...
      >
        ...
        <div className="space-y-4 grid justify-items-center">
          {opcionMultiple.map((dato) => (
            <div
              className="bg-white py-10 px-5 mb-10  lg:mb-0 shadow-md rounded-md 2xl:w-3/4 xl:w-3/4 lg:w-3/4 md:w-3/4 sm:w-full"
              key={dato.label}
            >
              <label
          ...
          {preguntasAbiertas.map((dato) => (
            <div
              className="bg-white py-9 px-5 mb-10 w-full lg:mb-0 shadow-md rounded-md 2xl:w-3/4 xl:w-3/4 lg:w-3/4 md:w-3/4 sm:w-full"
              key={dato.label}
            >
              <label
                htmlFor={dato.htmlFor}
